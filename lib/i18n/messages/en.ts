...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "appUpdate.releaseNotes": "RANOA v{version} is available. View release notes",
    ...
    "system.label": "System",
    "system.readOnly": "Effective instructions for this session · read-only",
    ...
    "session.workBranch": "Working branch",
    "session.branchLocked": "The working branch stays fixed after this session is created. Start a new session to switch branches.",
    "session.checkout": "Checkout",
    "session.repository": "Repository",
    "session.branchKind": "Workspace type",
    "session.mainCheckout": "Main checkout",
    "session.worktreeCheckout": "Independent worktree",
    ...
    "workspaceContext.label": "New session work context",
    "workspaceContext.local": "Local",
    "workspaceContext.localTitle": "Run in the local workspace",
    "workspaceContext.noProject": "Select project",
    "workspaceContext.checking": "Checking…",
    "workspaceContext.noBranch": "No branch",
    "workspaceContext.chooseBranch": "Choose or create a working branch",
    "workspaceContext.branchUnavailable": "Start from a Git repository root to choose a branch",
    "workspaceContext.branchTitle": "Working branch",
    "workspaceContext.createBranch": "Create branch and worktree",
    "workspaceContext.firstSessionOnly": "Editable before the session is created",
    ...
    "sidebar.new": "New",
    "sidebar.newConversation": "New session",
    "sidebar.newConversationHint": "Begin a new journey in this workspace",
    "sidebar.globalTools": "Global tools",
    "sidebar.globalToolsHint": "Applies to every session",
    "sidebar.modelsHint": "Providers and routing",
    "sidebar.skillsHint": "Rules and workflows",
    "sidebar.pluginsHint": "Extensions and links",
    "sidebar.settings": "Settings",
    "sidebar.settingsHint": "Models, skills, and plugins",
    "settings.title": "Settings",
    "settings.subtitle": "RANOA workbench configuration",
    "settings.capabilities": "Capabilities",
    "settings.general": "General",
    "settings.generalDescription": "Language and interface preferences",
    "settings.interfaceLanguage": "Interface language",
    "settings.interfaceLanguageDescription": "Choose the language used across the RANOA workbench.",
    "settings.languageChinese": "Simplified Chinese",
    "settings.languageEnglish": "English",
    "settings.appearance": "Appearance",
    "settings.appearanceDescription": "Wallpaper and adaptive color",
    "settings.sync": "Cloud sync",
    "settings.syncDescription": "Devices, revisions, and safe recovery",
    "settings.modelsDescription": "Providers, routing, and models",
    "settings.skillsDescription": "Rules, memory, and workflows",
    "settings.pluginsDescription": "Extensions, connections, and runtime",
    "settings.noWorkspace": "Select a workspace to configure skills and plugins",
    "sync.title": "Cloud sync center",
    "sync.description": "Sync only your own devices: create the space once, then join other devices with a pairing code.",
    "sync.personalTitle": "Personal device sync",
    "sync.disconnected": "Not connected",
    "sync.connected": "Connected",
    "sync.connectedToVault": "Connected to sync vault",
    "sync.scanComplete": "Inventory updated",
    "sync.progressTitle": "Sync route",
    "sync.phaseLabel": "Phase 01 · Local inventory",
    "sync.step.inventory": "Inventory",
    "sync.step.encryption": "Encrypt",
    "sync.step.ready": "Awaiting link",
    "sync.step.server": "Server address",
    "sync.step.device": "Pair device",
    "sync.step.sync": "Start syncing",
    "sync.connectionTitle": "Bring sync to your server",
    "sync.connectionDescription": "Sign in to your Ubuntu server once. RANOA installs the sync service, creates the secure space, and remembers this device.",
    "sync.endpointTitle": "Remote sync service",
    "sync.endpointDescription": "Enter the server IP or hostname and port. You do not need to compose a full URL.",
    "sync.localTunnelTitle": "Local SSH tunnel",
    "sync.localTunnelDescription": "This is a local address and works only on this computer. Use the server address on other devices, or create an SSH tunnel first.",
    "sync.localPreview": "Local preview",
    "sync.notConnected": "Not connected yet",
    "sync.connectLater": "Choose a connection path above",
    "sync.pairDevice": "My devices",
    "sync.deviceSecurityDescription": "A connected device confirms the first pairing once. After that, this device can sync on its own.",
    "sync.endpoint": "Sync server address",
    "sync.serverHost": "Server IP / hostname",
    "sync.serverPort": "Port",
    "sync.serverHostPlaceholder": "e.g. 129.204.42.30",
    "sync.serverPortPlaceholder": "e.g. 34141",
    "sync.deployHost": "Your server IP",
    "sync.sshPort": "SSH port",
    "sync.sshUsername": "SSH username",
    "sync.sshUsernamePlaceholder": "e.g. root or ubuntu",
    "sync.sshPassword": "SSH password",
    "sync.sshPasswordPlaceholder": "Used for this installation only",
    "sync.serverLoginTitle": "Server login",
    "sync.serverLoginHint": "Used only for this installation; it is not used for daily sync.",
    "sync.deployAndStart": "Deploy server and start syncing",
    "sync.deploying": "Deploying and creating your sync space…",
    "sync.deployComplete": "Server deployed and sync space created",
    "sync.deployFailed": "Unable to deploy the sync server",
    "sync.serverAddressPreview": "The connection address will appear here",
    "sync.addCredentials": "Add account and password",
    "sync.hideCredentials": "Hide account and password",
    "sync.serverUsername": "Server account (optional)",
    "sync.serverPassword": "Server password (optional)",
    "sync.serverUsernamePlaceholder": "Only if the server enables account auth",
    "sync.serverPasswordPlaceholder": "Stored on this device only",
    "sync.passwordSavedPlaceholder": "Password saved; leave blank to keep it",
    "sync.serverCredentialsHint": "Only fill these when the sync server is configured with account authentication. The password stays in this device's private config and is never synced.",
    "sync.deviceName": "This device's name",
    "sync.createVault": "Create sync space",
    "sync.joinWithCode": "Connect to my sync space",
    "sync.setupCreate": "Deploy my sync server",
    "sync.setupCreateHint": "Install, configure, and create the first sync space",
    "sync.setupJoin": "I already have a device",
    "sync.setupJoinHint": "Join with a code from another device",
    "sync.setupCreateGuide": "First time: enter the server IP, SSH account, and password → deploy automatically → sync this device securely.",
    "sync.setupJoinGuide": "Already connected elsewhere? Create a pairing code there, then paste it here.",
    "sync.pairCode": "Pairing code",
    "sync.pairCodePlaceholder": "Enter the 10-character code",
    "sync.pairCodeHint": "On another connected device, choose “Create pairing code”, then paste the 10-character code here.",
    "sync.pairingCode": "Pairing code",
    "sync.createPairingCode": "Create pairing code",
    "sync.copy": "Copy",
    "sync.copied": "Copied to clipboard",
    "sync.requestPending": "Waiting for approval on another device",
    "sync.checkPairing": "Check status",
    "sync.copyDeviceKey": "Copy device key",
    "sync.approveDevice": "Approve a new device",
    "sync.approveDeviceHint": "Paste the request ID and public key shown on the new device. The vault key is wrapped only for it.",
    "sync.requestId": "Request ID",
    "sync.devicePublicKey": "Device public key",
    "sync.devicePublicKeyPlaceholder": "Paste the new device public key",
    "sync.approve": "Approve",
    "sync.pairingRequested": "Pairing request sent. Waiting for the vault owner.",
    "sync.pairingWaiting": "The request is still waiting for approval.",
    "sync.pairingComplete": "Device joined the vault securely.",
    "sync.deviceApproved": "Device approved. Waiting for it to finish receiving the key.",
    "sync.vaultCreated": "Vault created. This device is now the owner.",
    "sync.actionFailed": "Sync action failed",
    "sync.working": "Working…",
    "sync.localInventory": "Local inventory",
    "sync.localInventoryDescription": "Scanning reads file fingerprints only. Nothing is uploaded or overwritten, and credential contents are never read.",
    "sync.scanNow": "Scan this device",
    "sync.previewPlan": "Preview sync plan",
    "sync.planTitle": "First sync plan",
    "sync.planDescription": "Review changes before committing; a recovery snapshot is created first.",
    "sync.cursor": "Cursor",
    "sync.toUpload": "To upload",
    "sync.toDownload": "To download",
    "sync.conflicts": "Conflicts",
    "sync.missingChunks": "Missing chunks",
    "sync.uploadChanges": "Upload local changes",
    "sync.downloadChanges": "Download remote changes",
    "sync.planReady": "Sync plan ready.",
    "sync.planConflictWarning": "Found {count} conflicts. Automatic execution is paused until they are resolved.",
    "sync.uploadComplete": "Uploaded {count} objects with a recovery snapshot kept.",
    "sync.downloadComplete": "Downloaded {count} objects with a local recovery snapshot kept.",
    "sync.codeCreated": "Pairing code created. It expires in 10 minutes.",
    "sync.deviceFingerprint": "Device fingerprint",
    "sync.epoch": "Server epoch",
    "sync.encryptedTransport": "End-to-end encrypted",
    "sync.scanning": "Scanning…",
    "sync.files": "Included files",
    "sync.size": "Data size",
    "sync.lastScan": "Last scan",
    "sync.notScanned": "Not scanned",
    "sync.filesUnit": "files",
    "sync.safetyTitle": "Safety boundary locked",
    "sync.safetyDescription": "Credentials, trust state, caches, and platform binaries stay excluded; upload opens only after the sync plan is confirmed.",
    "sync.uploadDisabled": "Upload disabled",
    "sync.manifestFingerprint": "Manifest fingerprint",
    "sync.excludedTitle": "{count} data groups safely excluded",
    "sync.excludedReason.credentials": "Sensitive credentials",
    "sync.excludedReason.cache": "Cache data",
    "sync.excludedReason.device-local": "Device-local state",
    "sync.excludedReason.platform-specific": "Platform resources",
    "sync.category.sessions": "Sessions",
    "sync.category.models": "Model config",
    "sync.category.settings": "Workbench settings",
    "sync.category.skills": "Skills",
    "sync.category.extensions": "Extensions",
    "sync.operationsTitle": "Devices & recovery",
    "sync.operationsDescription": "Manage trusted devices, conflicts, recovery snapshots, and recent security actions.",
    "sync.refreshDetails": "Refresh status",
    "sync.devicesTitle": "Trusted devices",
    "sync.conflictCenter": "Conflict center",
    "sync.snapshotsTitle": "Recovery snapshots",
    "sync.revoke": "Revoke",
    "sync.keepRemote": "Keep remote",
    "sync.noConflicts": "No conflicts are waiting.",
    "sync.noSnapshots": "Recovery points appear here after the first sync.",
    "sync.conflictRevision": "Local r{local} · Remote r{remote}",
    "sync.conflictResolved": "Conflict marked to keep the remote revision.",
    "sync.restore": "Restore",
    "sync.restoreConfirm": "This will restore {count} objects. A recovery snapshot will be created first. Continue?",
    "sync.restoreComplete": "Restored {count} objects and created a pre-restore snapshot.",
    "sync.auditTitle": "Security audit ({count} events)",
    "appearance.smartColor": "Adaptive ambient color",
    "appearance.smartColorDescription": "Calibrates the sidebar, glass surfaces, composer, and accents for each wallpaper while preserving readable contrast.",
    "appearance.enabled": "Enabled",
    "appearance.companion": "Desktop familiar",
    "appearance.companionDescription": "Follows the selected character and work state. Your visibility preference is remembered.",
    "appearance.companionOn": "Summoned",
    "appearance.companionOff": "Sleeping",
    "topbar.appActions": "Application shortcuts",
    "topbar.desktopPet": "Familiar",
    "topbar.showDesktopPet": "Summon desktop familiar",
    "topbar.hideDesktopPet": "Hide desktop familiar",
    "topbar.openSettings": "Open settings",
    "topbar.gameCenterSoon": "Game Center · Coming soon",
    "appearance.wallpaper": "Wallpaper presets",
    "appearance.wallpaperDescription": "Every wallpaper carries its own calibrated interface palette.",
    "appearance.roxy": "Roxy · Astral Study",
    "appearance.roxyDescription": "Quiet, focused, and comfortable for long sessions",
    "appearance.roxyPalette": "Moonlit blue",
    "appearance.sylphiette": "Sylphiette · Moonlit Conservatory",
    "appearance.sylphietteDescription": "Airy, gentle, and naturally restorative",
    "appearance.sylphiettePalette": "Pearl mint",
    "appearance.eris": "Eris · Ember Sword Gallery",
    "appearance.erisDescription": "Warm, decisive, and charged with momentum",
    "appearance.erisPalette": "Crimson amber",
    "appearance.darkFirst": "Immersive dark first",
    "appearance.darkFirstDescription": "Wallpaper changes use the dark interface, then apply the preset's calibrated palette.",
    "empty.workbench": "AGENTIC WORKBENCH",
    "empty.title": "Chart the unwritten",
    "empty.description": "Begin with an intent. RANOA keeps thought, tools, and code moving in one continuous workspace.",
    "empty.ready": "Ready for your first instruction",
    "sidebar.newSessionTitle": "New session in {path}",
    "sidebar.refresh": "Refresh",
    "sidebar.refreshing": "Refreshing sessions",
    "sidebar.refreshComplete": "Sessions refreshed",
    ...
    "files.shiftClickMention": "Shift+click to mention in chat",
    "files.dropFilesHere": "Drop files here to upload into this folder",
    "files.uploadedTo": "Uploaded to {path}",
    ...
    "files.refreshComplete": "Refresh complete",
    ...
    "chat.send": "Send",
    "chat.shortcutSend": "send",
    "chat.shortcutNewline": "new line",
    "chat.attachImage": "Attach files",
