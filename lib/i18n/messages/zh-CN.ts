...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sync.title": "云同步中心",
    "sync.description": "把会话、模型与工作流安全地带到每一台设备，同时保留版本与冲突记录。",
    ...
    "sync.connectionTitle": "同步连接",
    "sync.connectionDescription": "第一阶段先建立本地数据清单，确认范围后再连接服务器。",
    "sync.localPreview": "本地预览",
    "sync.notConnected": "尚未连接同步服务器",
    "sync.connectLater": "服务器配对将在下一步启用",
    "sync.pairDevice": "配对设备",
    "sync.endpoint": "服务器地址",
    "sync.deviceName": "设备名称",
    "sync.createVault": "创建保险库",
    "sync.joinWithCode": "使用配对码加入",
    "sync.pairCode": "配对码",
    "sync.pairCodePlaceholder": "输入 10 位配对码",
    "sync.pairCodeHint": "在已连接的设备上生成配对码，然后在这里加入。",
