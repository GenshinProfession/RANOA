...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sync.description": "Carry sessions, models, and workflows across devices with revisions and conflict history intact.",
    ...
    "sync.connectionTitle": "Sync connection",
    "sync.connectionDescription": "Phase one builds a local inventory before any server connection or upload is enabled.",
    "sync.localPreview": "Local preview",
    "sync.notConnected": "No sync server connected",
    "sync.connectLater": "Server pairing will be enabled next",
    "sync.pairDevice": "Pair device",
    "sync.endpoint": "Server endpoint",
    "sync.deviceName": "Device name",
    "sync.createVault": "Create vault",
    "sync.joinWithCode": "Join with code",
    "sync.pairCode": "Pairing code",
    "sync.pairCodePlaceholder": "Enter the 10-character code",
    "sync.pairCodeHint": "Generate a pairing code on an already connected device, then join here.",
