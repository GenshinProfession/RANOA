...
export function ModelsConfig({ onClose, embedded = false }: { onClose: () => void; embedded?: boolean }) {
  ...
  return (
    <>
    <div className={`resource-config-frame${embedded ? " is-embedded" : ""}`} style={embedded
      ? { position: "relative", width: "100%", height: "100%", display: "flex", minHeight: 0 }
      ...
      <div className="resource-config-surface" style={embedded
        ? { width: "100%", height: "100%", minHeight: 0, background: "var(--bg)", display: "flex", flexDirection: "column", overflow: "hidden" }
